...
def generate_patient_scenario_prompt(
    ...
    base_prompt_content = (
        ...
        "**SPÓJNOŚĆ KLINICZNA:**\n"
        "Najpierw ustal jeden wewnętrzny stan pacjenta (objawy, parametry życiowe, badanie fizykalne i wyniki). "
        "Każdy późniejszy opis musi być z nim zgodny; nie podawaj wzajemnie sprzecznych ustaleń, np. jednocześnie "
        "obrzęków podudzi i braku obrzęków.\n"
        "Informacje z wywiadu oznacz jako zgłaszane przez pacjenta i ujawniaj je wyłącznie w odpowiedzi na pytanie lekarza. "
        "W badaniu przedmiotowym podawaj tylko obserwowalne, obiektywne ustalenia.\n\n"
    ...
    return [
        {
            ...
            "content": (
                ...
                "Oddziel badanie przedmiotowe od wywiadu: nie przedstawiaj informacji zgłaszanych przez pacjenta "
                "jako obiektywnego wyniku badania. Zachowaj pełną zgodność z ustalonym stanem pacjenta; "
                "nie zaprzeczaj wcześniej ujawnionym wiarygodnym ustaleniom. "
                "Jeżeli badanie nie zostało wykonane albo nie jest wskazane w tym scenariuszu, napisz to wprost "
                "w formacie „Niewykonano, ponieważ …” i podaj konkretny powód kliniczny. "
                "Używaj standardowych opisów klinicznych; nie określaj tonów serca jako „głośne” bez istotnego, "
                "precyzyjnie opisanego kontekstu. "
